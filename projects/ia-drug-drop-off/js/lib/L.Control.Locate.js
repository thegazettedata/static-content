var locate_latlng;
var nearest_neighbor_table = false;
...
(function (factory, window) {
    ...
    var LocateControl = L.Control.extend({
        ...
        _drawMarker: function() {
            ...
            locate_latlng = latlng;
            
            // Render table with closest locations only once
            if (!nearest_neighbor_table) {
                nearestNeighbor(locate_latlng);
                nearest_neighbor_table = true;
            }
        ...
        _setClasses: function(state) {
            if (state == 'requesting') {
                var text = 'Looking up your address';
            } else {
                var text = 'Toggle marker';
            }
            $('.leaflet-control-locate .address').html(text);
